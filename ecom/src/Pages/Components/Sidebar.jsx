    ...
    return (
        <>
            <div className="list-group">
                ...
                <NavLink to="/" className="list-group-item bg-primary text-light mb-1"><i className="fa fa-list fs-4"></i><span className='float-end'>Sub Category</span></NavLink>
                <NavLink to="/" className="list-group-item bg-primary text-light mb-1"><i className="fa fa-list fs-4"></i><span className='float-end'>Brand</span></NavLink>
                <NavLink to="/" className="list-group-item bg-primary text-light mb-1"><i className="fa fa-list fs-4"></i><span className='float-end'>Product</span></NavLink>
                <NavLink to="/" className="list-group-item bg-primary text-light mb-1"><i className="fa fa-star fs-4"></i><span className='float-end'>Testimonials</span></NavLink>
