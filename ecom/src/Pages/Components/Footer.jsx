        ...
        <div className="container">
          <div className="row g-4 align-items-center">
            <div className="col-md-6 text-center text-md-end mb-md-0">
              <span className="text-body"><a href="#" className="border-bottom text-white"><i className="fas fa-copyright text-light me-2"></i>getinfoplus.com</a>, All right reserved.</span>
            </div>
            <div className="col-md-6 text-center text-md-start text-body">
              Designed & Developed By <a className="border-bottom text-white" href="https://abhishek.getinfoplus.com">Abhishek Shrivastav</a>
            </div>
          </div>
        </div>
      </div>
