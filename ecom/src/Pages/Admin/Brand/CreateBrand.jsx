...
import { createBrand } from '../../../Redux/ActionCreators/BrandActionCreators'
        ...
        <div className='container-fluid my-3'>
            <div className='row'>
                ...
                <div className='col-md-9'>
                    <div className='bg-primary p-2 text-light text-center'>Create Brand <Link to='/admin/brand' className='fa fa-backward float-end text-light' > Back</Link></div><br />
                    <div className='container'>
                        <form onSubmit={postData}>
                            <div className="row">
                                <div className="form-group col-md-4">
                                    <label >Brand Name*</label>
                                    <input type="text" name="name" onChange={getInputData} className={`form-control ${show && errorMessage.name ? 'border-danger' : ''}`} id="nameFormControlInput1" placeholder="Enter Brand Name" />
