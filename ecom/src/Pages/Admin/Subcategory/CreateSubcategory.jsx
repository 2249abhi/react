...
import { createSubcategory } from '../../../Redux/ActionCreators/SubcategoryActionCreators'
   ...
   async function postData(e) {
        ...
        if (error) {
            ...
            /* let response = await fetch(`${process.env.REACT_APP_SERVER}/subcategory`,{
                ...
                // dispatch(createSubcategory(item))
                        ...
                        <form onSubmit={postData}>
                            <div className="row">
                                <div className="form-group col-md-4">
                                    ...
                                    <input type="text" name="name" onChange={getInputData} className={`form-control ${show && errorMessage.name ? 'border-danger' : ''}`} id="nameFormControlInput1" placeholder="Enter Sub Category Name" />
